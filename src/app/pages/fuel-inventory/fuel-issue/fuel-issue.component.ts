...
@Component({
  selector: 'app-fuel-issue',
  templateUrl: './fuel-issue.component.html',
  styleUrls: ['./fuel-issue.component.scss']
})
export class FuelIssueComponent implements OnInit {
  ...
  getRequestDetails() {
    ...
    this.custservice.getFuelRequestData(obj).subscribe((res: any) => {
      console.log(res);
  ...
  getRequestNo() {
    ...
    this.custservice.getFuelRequestNumber(obj).subscribe((res: any) => {
  ...
  savefinaldata(fr: any) {
    if (this.btnSaveUpdate === "Save") {
      ...
      this.custservice.addFuelIssueData(obj).subscribe((res: any) => {
        console.log(res);
  ...
  getFuelIssueList() {
    ...
    this.custservice.getFuelIssueData(obj).subscribe((res: any) => {
      console.log(res);
      this.reaData = false;
  ...
  saveeditreason() {
    ...
    this.custservice.editFuelIssue(obj).subscribe((res: any) => {
      console.log(res);
      this.dialog.closeAll();
      this.editModel.reason = "";
  ...
  uploadWbsFile(fileInput: any) {
    ...
    const postData = new FormData();
    postData.append("document_type", "Fuel Issue");
  ...
  deleteFile() {
    ...
    this.custservice.deleteFuelIssueFile(obj).subscribe((res: any) => {
      if (res && res["status_code"] == "200") {
        this.alertcall.showSuccess("Accepted", res["message"]);
