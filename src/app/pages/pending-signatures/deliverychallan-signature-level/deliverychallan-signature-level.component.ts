...
@Component({
  selector: 'app-deliverychallan-signature-level',
  templateUrl: './deliverychallan-signature-level.component.html',
  styleUrls: ['./deliverychallan-signature-level.component.scss']
})
export class DeliverychallanSignatureLevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/inventory/print-dc'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
