...
@Component({
  selector: 'app-purchaseordersignaturelevel',
  templateUrl: './purchaseordersignaturelevel.component.html',
  styleUrls: ['./purchaseordersignaturelevel.component.scss']
})
export class PurchaseordersignaturelevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/cp/print_purchase_order'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
