...
@Component({
  selector: 'app-goodissuereceipt-signature-level',
  templateUrl: './goodissuereceipt-signature-level.component.html',
  styleUrls: ['./goodissuereceipt-signature-level.component.scss']
})
export class GoodissuereceiptSignatureLevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/inventory/printdmr'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
