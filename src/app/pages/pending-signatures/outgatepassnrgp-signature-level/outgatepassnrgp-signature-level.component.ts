...
@Component({
  selector: 'app-outgatepassnrgp-signature-level',
  templateUrl: './outgatepassnrgp-signature-level.component.html',
  styleUrls: ['./outgatepassnrgp-signature-level.component.scss']
})
export class OutgatepassnrgpSignatureLevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/inventory/printoutgatepassrgpnrgp1'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
