...
@Component({
  selector: 'app-purchaserequestsignaturelevel',
  templateUrl: './purchaserequestsignaturelevel.component.html',
  styleUrls: ['./purchaserequestsignaturelevel.component.scss']
})
export class PurchaserequestsignaturelevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/planning/printpurchasereq'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
