...
@Component({
  selector: 'app-workrequestsignaturelevel',
  templateUrl: './workrequestsignaturelevel.component.html',
  styleUrls: ['./workrequestsignaturelevel.component.scss']
})
export class WorkrequestsignaturelevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data:any){
    ...
    this.router.navigate(['/planning/printworkreq'],{ queryParams: {'document_number': data.document_number,'position':data.level}})
  } 
