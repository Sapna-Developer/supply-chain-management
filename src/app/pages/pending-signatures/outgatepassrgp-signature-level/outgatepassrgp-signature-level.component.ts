...
@Component({
  selector: 'app-outgatepassrgp-signature-level',
  templateUrl: './outgatepassrgp-signature-level.component.html',
  styleUrls: ['./outgatepassrgp-signature-level.component.scss']
})
export class OutgatepassrgpSignatureLevelComponent implements OnInit {
  pageIndex: any = 1;
  pageSize: any = 10;
  demo1TabIndex: any = 0;
  ...
  printdmr(data: any) {
    ...
    this.router.navigate(['/inventory/printoutgatepassrgp1'], { queryParams: { 'document_number': data.document_number, 'position': data.level } })
  }
