...
@Component({
  selector: 'app-goodsissuerequest2',
  templateUrl: './goodsissuerequest2.component.html',
  styleUrls: ['./goodsissuerequest2.component.scss']
})
export class Goodsissuerequest2Component implements OnInit {
  ...
  this.custservice.vehicleMasterListData(obj).subscribe((res:any)=>{
   ...
   this.vehicledata=res.data
    ...
    getData() {
      ...
      this.custservice.getgoodsissuerequest2(obj).subscribe((res: any) => {
        this.reaData = false;
    ...
    editupdatedData(data: any) {
      ...
      this.custservice.editgoodsissuerequest2(obj).subscribe((res: any) => {
        this.finaldataarray = res.data;
        this.dataSource.data = this.finaldataarray;
    ...
    deleteItem() {
      ...
      this.custservice.deletegoodsissuerequest2(obj).subscribe((res: any) => {
        console.log(obj);
        if (res && res["status_code"] == "200") {
          this.alertcall.showSuccess("Accepted", res["message"]);
          this.dialog.closeAll();
    ...
    printdmr(data: any) {
      ...
      this.router.navigate(["/planning2/printgoodsissuerequest2"], 
      {
