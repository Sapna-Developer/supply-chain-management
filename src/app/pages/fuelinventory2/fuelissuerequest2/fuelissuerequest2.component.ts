...
@Component({
  selector: 'app-fuelissuerequest2',
  templateUrl: './fuelissuerequest2.component.html',
  styleUrls: ['./fuelissuerequest2.component.scss']
})
export class Fuelissuerequest2Component implements OnInit {
  ...
  savefinaldata(fr: any) {
    if (this.btn === "Save") {
      ...
      this.custService.addFuelIssueReq2(obj).subscribe((res: any) => {
        console.log(res);
    ...
    if (this.btn === "Update") {
      ...
      this.custService.updateFuelIssueRequest2(obj).subscribe((res: any) => {
        if (res && res["status_code"] == "200") {
          Swal.fire({
            text: res["message"],
            title: res["reference"],
  ...
  getFuelIssueReqList() {
    ...
    this.custService.getFuelIssueReqData2(obj).subscribe((res: any) => {
      console.log(res);
      this.reaData = false;
  ...
  deleteFile() {
    ...
    this.custService.deleteFuelIssueReqFile2(obj).subscribe((res: any) => {
      if (res && res["status_code"] == "200") {
        this.alertcall.showSuccess("Accepted", res["message"]);
  ...
  uploadedselctedfiles() {
    ...
    postData.append("document_type", "FuelIssueRequest2");
  ...
  getexistingfiles() {
    ...
    params = new HttpParams()
      ...
      .set("document_type", "FuelIssueRequest2");
  ...
  deleteexistingfile() {
    ...
    params = new HttpParams()
      .set("document_number", this.firnumber)
      .set("document_type", "FuleIssueRequest2")
