...
@Component({
  selector: 'app-bunkconfirmations2',
  templateUrl: './bunkconfirmations2.component.html',
  styleUrls: ['./bunkconfirmations2.component.scss']
})
export class Bunkconfirmations2Component implements OnInit {
  ...
  savefinaldata(fr: any) {
    if (this.btn === "Save") {
      ...
      this.custService.addBunkConfirm2(obj).subscribe((res: any) => {
        console.log(res);
    ...
    if (this.btn === "Update") {
      ...
      this.custService.updateBunkConfirmation2(obj).subscribe((res: any) => {
        if (res && res["status_code"] == "200") {
          Swal.fire({
            text: res["message"],
            title: res["reference"],
  ...
  getBunkConfirmList() {
    ...
    this.custService.getBunkConfirmData2(obj).subscribe((res: any) => {
      console.log(res);
      this.reaData = false;
  ...
  deleteFile() {
    ...
    this.custService.deleteBunkConfirmFile2(obj).subscribe((res: any) => {
      if (res) {
        this.alertcall.showSuccess("Accepted", res["message"]);
  ...
  uploadedselctedfiles() {
    ...
    postData.append("document_type", "BunkConfirmation2");
  ...
  getexistingfiles() {
    ...
    params = new HttpParams()
      ...
      .set("document_type", "BunkConfirmation2");
