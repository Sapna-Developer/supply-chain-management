...
@Component({
  selector: 'app-vendorbank2',
  templateUrl: './vendorbank2.component.html',
  styleUrls: ['./vendorbank2.component.scss']
})
export class Vendorbank2Component implements OnInit {

  dataSourceList = new MatTableDataSource()
  displayedColumnsList = [
    "sno", "number", "date",
    //  "company_name", "company_code", 
    "vendor_name", "vendor_code", "purchase_order_number",
  ...
  getVendorBunkRequestListData() {
    ...
    this.custservice.vendorBunkRequestList2(obj).subscribe((res: any) => {
      // debugger;
      // console.log("hello")
      this.reaData = false;
  ...
  saveeditreason() {
    ...
    this.custservice.addVendorBunkReqData2(obj).subscribe((res: any) => {
  ...
  editItem() {
    ...
    this.custservice.editVendorBunkRequest2(obj).subscribe((res: any) => {
      console.log(res)
  ...
  printvbr(data: any) {
    ...
    this.router.navigate(["/fuelinventory2/printvendorbunkrequest"], {
  ...
  getexistingfiles() {
    ...
    params = new HttpParams()
      ...
      .set("document_type", "VendorBunkRequest2")
    // let obj={
  ...
  uploadWbsFile(fileInput: any) {
    ...
    postData.append("document_type", "VendorBunkRequest2");
  ...
  deleteItem() {
    ...
    this.custservice.deletevendorBunkRequest2(obj).subscribe((res: any) => {
      console.log(obj);
      if (res && res['status_code'] == "200") {
        this.alertcall.showSuccess('Accepted', res['message']);
        this.dialog.closeAll()
    ...
    this.dialog.closeAll()
      ...
      submitpono(fr: any) {
        ...
        this.custservice.getpurchaseorderdata2(obj).subscribe((res: any) => {
          ...
          // this.dataSourceList.data = this.formdatatotablearray;      
          this.tabledata = res.data[0];
          this.formdata.vendor_name=this.tabledata.vendor_name;
          this.formdata.Purchase_Order_Date=moment(this.tabledata.date).format("YYYY-MM-DD"),
          this.tabledata.mat_code = this.tabledata.material_code,
          this.formdata.vendor_code = this.tabledata.vendor_code,
          this.tabledata.mat_desc = this.tabledata.material_description,
          this.formdata.purchase_order_number=this.tabledata.number;
          this.tabledata.uom = this.tabledata.unit_of_measurment,
          // this.tabledata.quantity = this.tabledata.quantity
          this.dialog.closeAll();
          // this.ponumber = "";
        });
      }
