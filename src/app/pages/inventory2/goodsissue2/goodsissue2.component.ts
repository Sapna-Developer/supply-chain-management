...
@Component({
  selector: 'app-goodsissue2',
  templateUrl: './goodsissue2.component.html',
  styleUrls: ['./goodsissue2.component.scss']
})
export class Goodsissue2Component implements OnInit {
  ...
  selectedreqnumber() {
    ...
    this.custservice.addgoodsissuerequest2(obj).subscribe((res: any) => {
      console.log(res);
      if(res){
        ...
        (this.model1.companyname = this.firstrecord.company_name),
          ...
          (this.model1.receivername =this.firstrecord.receiver_name),
          (this.model1.vehiclenumber =this.firstrecord.vehicle_number);
          (this.model1.requestdate= moment(this.firstrecord.date).format(
            "YYYY-MM-DD"
          )),
          (this.model1.workordernumber =this.firstrecord.work_order_number);
          (this.model1.purpose=this.firstrecord.purpose);
  ...
  printdmr(data: any) {
    ...
    //   }
    // };
    this.router.navigate(["/inventory2/printgoodsissue2"], {
  ...
  deleteFile() {
    ...
    this.custservice.deletegoodsissue2(obj).subscribe((res: any) => {
      if (res && res["status_code"] == "200") {
        this.alertcall.showSuccess("Accepted", res["message"]);
  ...
  getData() {
    ...
    this.custservice.getSearchGoodsIssue2(obj).subscribe((res: any) => {
      console.log(res);
  ...
  savefinaldata(fr: any) {
    if (this.btn == "Save") {
      ...
      this.custservice.addgoodsissue2(obj).subscribe((res: any) => {
        if (res && res["status_code"] == "200") {
          // this.alertcall.showSuccess('Accepted', res['message']);
          Swal.fire({
            text: res["message"],
      ...
      let obj = {
        ...
        receiver_name: this.model1.receivername,
        request_number: this.model1.requestnumber,
        request_date: moment(this.model1.request_date).format("YYYY-MM-DD"),
        issue_type: "Type1",
        locations: this.model1.locations,
        line_item: this.SNO,
        material_code: this.matCode,
  ...
  editdata(row1: any, index: any, data: any) {
    ...
    // this.model2.matcode = this.systemref || row1.system_reference_1;
    this.model2.matcode = this.systemref  || this.matDesc;
    console.log(this.model2.matcode);
  ...
  getmaterialreqData() {
    ...
    this.custservice.addgoodsissuerequest22(obj).subscribe((res: any) => {
  ...
  saveeditreason() {
    ...
    this.custservice.addgoodsissue2(obj).subscribe((res: any) => {
      ...
      // (this.model1.dateee = moment(this.editdataa.date).format("YYYY-MM-DD")),
        ...
        (this.model1.requestdate = moment(this.editdataa.date).format(
          "YYYY-MM-DD"
        )),
        ...
        (this.model1.workordernumber = this.editdataa.work_order_number),
        (this.model1.purpose=this.editdataa.purpose),
        // (this.model1.requesttype = this.editdataa.request_type);
      this.demo1TabIndex = 0;
      this.btn = "Update";
      console.log(this.model1.requestdate);
