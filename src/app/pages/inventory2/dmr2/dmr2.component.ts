...
@Component({
  selector: "app-dmr2",
  templateUrl: "./dmr2.component.html",
  styleUrls: ["./dmr2.component.scss"],
})
export class Dmr2Component implements OnInit {
  ...
  openfileuploadmodel(data: any, row1: any) {
    ...
    this.dmrnumber2 = row1.number;
    this.getexistingfiles();
  }
  getexistingfiles() {
    let params = new HttpParams();
    params = new HttpParams()
      .set("document_number", this.dmrnumber2)
      .set("document_type", "Daily Material Receipt2");
  ...
  uploadWbsFile(fileInput: any) {
    ...
    postData.append("document_type", "Daily Material Receipt2");
    postData.append("document_number", this.dmrnumber2);
    for (const file of this.fileUploadUrls) postData.append("doc", file);
  ...
  uploaddmrfiles(fileInput: any) {
    if (
      ...
      this.fileUploadUrlsdmr2 = fileInput.target.files;
      console.log(this.fileUploadUrlsdmr2);
      for (const file of this.fileUploadUrlsdmr2) {
  ...
  uploadedselctedfiles() {
    const postData = new FormData();
    postData.append("document_type", "Daily Material Receipt2");
    postData.append("document_number", this.generateddmr2);
  ...
  submitdmrno(fr: any) {
    ...
    this.custservice.editmaterialreceiptdata2(obj).subscribe((res: any) => {
      ...
      this.model1.podate = moment(this.tabledata.purchase_order_date).format(
        "YYYY-MM-DD"
      );
      this.model1.genumber = this.tabledata.gate_entry_number;
      this.model1.gedate = moment(this.tabledata.gate_entry_date).format(
        "YYYY-MM-DD"
      );
      this.model1.invoicenumber = this.tabledata.invoice_number;
      this.model1.invdate = moment(this.tabledata.invoice_date).format(
        "YYYY-MM-DD"
      );
  ...
  deleteFile() {
    ...
    this.custservice.deletematerialreceiptdata2(obj).subscribe((res: any) => {
      if (res && res["status_code"] == "200") {
        this.alertcall.showSuccess("Accepted", res["message"]);
  ...
  getData() {
    ...
    this.custservice.getmaterialreceiptdata2(obj).subscribe((res: any) => {
      this.reaData = false;
  ...
  getdmrDATA(ev: any) {
    ...
    this.selecteddmr2 = ev.target.value;
    if (this.selecteddmr2.length > 2) {
      this.getdropdownData();
    }
    if (!this.selecteddmr2) {
      this.getdropdownData();
    }
  }
  getdropdownData() {
    let obj = {
      ...
      pid: 1,
      field:"number",
      key: this.selecteddmr2,
    };
    this.custservice.getmaterialreceiptdata2(obj).subscribe((res: any) => {
      this.DMRDATA2 = res.data;
    });
  }
  ...
  saveeditreason() {
    ...
    this.custservice.editmaterialreceiptdata2(obj).subscribe((res: any) => {
      ...
      this.model1.podate = moment(this.editabledata.purchase_order_date).format(
        "YYYY-MM-DD"
      );
      this.model1.genumber = this.editabledata.gate_entry_number;
      this.model1.gedate = moment(this.editabledata.gate_entry_date).format(
        "YYYY-MM-DD"
      );
      this.model1.invoicenumber = this.editabledata.invoice_number;
      this.model1.invdate = moment(this.editabledata.invoice_date).format(
        "YYYY-MM-DD"
      );
      this.model1.dcnumber = this.editabledata.dc_number;
      this.model1.dcdate = moment(this.editabledata.dc_date).format(
        "YYYY-MM-DD"
      );
      ...
      this.model1.irdate = moment(this.editabledata.lr_date).format(
        "YYYY-MM-DD"
      );
  ...
  saveupdateddata() {
    ...
    this.saveddataarray.forEach((ele: any, index) => {
      ...
      this.InvoiceQuantity.push(
        Number(ele.invoice_quantity) || Number(ele.invqty)
      );
      ...
      this.discPERCENT.push(
        Number(ele.discount_percent) || Number(ele.dispercentage)
      );
    ...
    this.saveddataarray.forEach((ele: any) => {
      this.freightSPLIT.push(
        ((ele.basicprice || ele.basic_price) / this.SUM) *
          this.editmodel.totalfreight
      );
      this.otherchargesSPLIT.push(
        ((ele.basicprice || ele.basic_price) / this.SUM) *
          this.editmodel.otherchargesval
      );
      this.othertaxSPLIT.push(
        ((ele.basicprice || ele.basic_price) / this.SUM) *
          this.editmodel.othertaxvalue
      );
      this.totalPRICE.push(
        +(ele.basicprice || ele.basic_price) +
          (ele.taxvalue || ele.tax_value) +
          ((ele.basicprice || ele.basic_price) / this.SUM) *
            this.editmodel.totalfreight +
          ((ele.basicprice || ele.basic_price) / this.SUM) *
            this.editmodel.otherchargesval +
  ...
  getstoragelocData() {
    ...
    this.custservice.getmatstoragelocdata2(obj).subscribe((res: any) => {
  ...
  getvehiclenumdata() {
    ...
    this.custservice.getmatvehiclenumdata2(obj).subscribe((res: any) => {
  ...
  savefinaldata() {
    if (this.btn == "Save") {
      ...
      this.saveddataarray.forEach((ele: any, index) => {
        ...
        this.InvoiceQuantity.push(
          Number(ele.invqty || ele.invoice_quantity) || 0
        );
        ...
        this.discPERCENT.push(
          Number(ele.dispercentage || ele.discount_percent) || 0
        );
      ...
      this.saveddataarray.forEach((ele: any) => {
        this.freightSPLIT.push(
          (ele.basicprice / this.SUM) * this.model1.totalfreight ||
            ele.freight_split ||
            0
        );
        this.otherchargesSPLIT.push(
          (ele.basicprice / this.SUM) * this.model1.otherchargesval ||
            ele.other_charges_split ||
            0
        );
        this.othertaxSPLIT.push(
          (ele.basicprice / this.SUM) * this.model1.othertaxvalue ||
            ele.other_tax_split ||
            0
        );
        this.totalPRICE.push(
      ...
      this.custservice.addmaterialreceiptdata2(obj).subscribe((res: any) => {
        if (res && res["status_code"] == "200") {
          // this.alertcall.showSuccess('Accepted', res['message']);
          Swal.fire({
            text: res["message"],
          ...
          this.POID = [];
          this.model1 = {};
          this.generateddmr2 = res["reference"];
          this.getData();
          this.getlogdata();
          if (this.fileUploadUrlsdmr2.length > 0) {
      ...
      this.custservice.addmaterialreceiptdata2(obj).subscribe((res: any) => {
        if (res && res["status_code"] == "200") {
          ...
          this.POID = [];
          this.model1 = {};
          this.generateddmr2 = this.editednumber;
          this.getData();
          this.getlogdata();
  ...
  editdata(row1: any, index: any, data: any) {
    ...
    this.model2.invqty = row1.invqty || row1.invoice_quantity;
    this.model2.recqty = row1.recqty || row1.received_quantity;
    this.model2.shrtqty = row1.shrtqty || row1.shortage_quantity;
    this.model2.excsqty = row1.excsqty || row1.excess_quantity;
    this.model2.unitprice = row1.unitprice || row1.unit_price;
    this.model2.dispercentage = row1.dispercentage || row1.discount_percent;
    this.model2.disvalue = row1.disvalue || row1.discount_value;
    this.model2.basicprice = row1.basicprice || row1.basic_price;
    this.model2.taxdescription = row1.tax_description || row1.taxdescription;
    this.model2.taxpercentage = row1.tax_percent || row1.taxpercentage;
    this.model2.taxvalue = row1.taxvalue || row1.tax_value;
  ...
  Invoicevalue(ev: any) {
    ...
    if (this.unitValue == 0) {
      ...
      this.model.basicprice =
        this.valuefrmrec * this.unitValue - this.model.disvalue;
    }
  ...
  Invoiceeditvalue(ev: any) {
    ...
    if (this.model2.unitValue == "") {
      ...
      this.model2.basicprice =
        this.model2.recqty * this.unitValueedit - this.model2.disvalue;
    } else {
      this.model2.basicprice =
        this.model2.recqty * this.model2.unitprice - this.model2.disvalue;
    }
  ...
  selectedunitprice(ev: any) {
    ...
    this.model.disvalue =
      this.valuefrmrec * this.unitValue * this.discValue * 0.01;
    this.model.basicprice =
      this.valuefrmrec * this.unitValue - this.model.disvalue;
  ...
  selectedunitpriceedit(ev: any) {
    if (this.model2.unitValue == "" && this.unitValueedit == 0) {
      ...
      this.model2.disvalue =
        this.valuefrmrecedit * this.unitValueedit * this.discValueedit * 0.01;
      this.model2.basicprice =
        this.valuefrmrecedit * this.unitValueedit - this.model2.disvalue;
    } else if (this.model2.unitValue) {
      this.model2.disvalue =
        this.model2.recqty *
        this.model2.unitValue *
        this.model2.disvalue *
        0.01;
      this.model2.basicprice =
        this.model2.recqty * this.model2.unitValue - this.model2.disvalue;
    }
  ...
  selecteddiscountpriceedit(ev: any) {
    if (this.model2.dispercentage == "" && this.discValueedit == 0) {
      ...
      this.model2.disvalue =
        this.model2.recqty *
        this.model2.unitprice *
        this.model2.dispercentage *
        0.01;
      this.model2.basicprice =
        this.model2.recqty * this.model2.unitprice - this.model2.disvalue;
    }
  ...
  selectedtax() {
    ...
    if (this.valuefrminv == 0) {
      ...
      this.model.taxvalue =
        this.model.basicprice * this.model.taxpercentage * 0.01;
  ...
  selectedtaxedit() {
    ...
    if (this.model2.taxpercentage) {
      this.model2.taxvalue =
        this.model2.basicprice * this.model2.taxpercentage * 0.01;
  ...
  selectedbasicfreight1(ev: any) {
    ...
    this.editmodel.frtaxvalue =
      this.basicFreight1 * this.freightPercentage1 * 0.01;
  ...
  selectedfreighttax() {
    this.taxData.forEach((element: any) => {
      if (element.code == this.model1.frtaxdescription) {
        ...
        this.model1.frtaxvalue =
          this.basicFreight * this.model1.frtaxpercentage * 0.01;
  ...
  selectedfreighttax1() {
    this.taxData.forEach((element: any) => {
      if (element.code == this.editmodel.frtaxdescription) {
        ...
        this.editmodel.frtaxvalue =
          this.basicFreight1 * this.editmodel.frtaxpercentage * 0.01;
        this.editmodel.totalfreight =
          +this.basicFreight1 + this.editmodel.frtaxvalue;
      }
    });
  }
  selectedTAXDESC() {
  ...
  search() {
    ...
    if (this.searchData.length > 2) {
      this.custservice.getdmr2searchData(obj).subscribe((res: any) => {
        this.reaData = false;
        this.totalRecords = res?.count;
        this.dataSourcemain.data = res.data;
        if (res.data.length == 0) {
