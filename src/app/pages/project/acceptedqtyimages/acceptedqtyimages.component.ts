...
@Component({
  selector: 'app-acceptedqtyimages',
  templateUrl: './acceptedqtyimages.component.html',
  styleUrls: ['./acceptedqtyimages.component.scss']
})
export class AcceptedqtyimagesComponent implements OnInit {
  resimages:any[]=[]
  @Input()
  taskObj: any = {};
data:any={}
  ...
  ngOnInit(): void {
    ...
    //    element.datee=element.created_date
  ...
  getTaskImages() {
    this.customerService
      .getacceptedqtyimages(this.data.id)
      .subscribe((resp: any) => {
        if (resp.status_code === 200) {
this.totalimages = resp.data.length
          this.taskImages$ = [];
