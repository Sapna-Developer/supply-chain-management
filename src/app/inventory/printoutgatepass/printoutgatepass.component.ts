...
@Component({
  selector: 'app-printoutgatepass',
  templateUrl: './printoutgatepass.component.html',
  styleUrls: ['./printoutgatepass.component.scss']
})
export class PrintoutgatepassComponent implements OnInit {
  key: any;
